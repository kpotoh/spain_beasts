...
trimmomatic PE -threads 20 data/raw/ВГС\ кант1V350045595_L04_81_1.fq.gz data/raw/ВГС\ кант1V350045595_L04_81_2.fq.gz data/interim/kant1_f_pa.fq.gz data/interim/kant1_f_unp.fq.gz data/interim/kant1_r_pa.fq.gz data/interim/kant1_r_unp.fq.gz ILLUMINACLIP:data/external/adapters.fa:2:30:10:2:True LEADING:3 TRAILING:3 MINLEN:36
